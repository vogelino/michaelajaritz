...
const FocusPage = () => (
	<Page pageName={pageName}>
		<MobilePicture
			src="/images/artworks/mobile/gallery.jpg"
			alt="Die Kunst"
		/>
		...
		<Paragraph timeout={1400}>
			{getText(`pages.${pageName}.content.textArt`)}
		</Paragraph>
		<MobilePicture
			src="/images/artworks/mobile/monalisa.jpg"
			alt="Der Mensch"
		/>
		...
		<MobilePicture
			src="/images/artworks/mobile/soapbubbles.jpg"
			alt="Die Methode"
		/>
		...
		<Paragraph timeout={1800}>
			{getText(`pages.${pageName}.content.textMethod`)}
		</Paragraph>
	</Page>
);
