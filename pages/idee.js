...
const IdeaPage = () => (
	<Page pageName="idee">
		...
		/>
		<Subtitle timeout={1000}>{getText('subtitle')}</Subtitle>
		...
		<Paragraph timeout={1800}>{getText('textIntro')}</Paragraph>
		...
		<Paragraph timeout={2000}>{getText('textMakeVisible')}</Paragraph>
		...
		<Paragraph timeout={2200}>{getText('textMakeRoom')}</Paragraph>
		...
		<Paragraph timeout={2400}>{getText('textMakePossible')}</Paragraph>
	</Page>
)
