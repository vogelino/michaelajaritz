	...
	pages: {
		...
		kooperationen: {
			...
			content: {
				...
				list: `<ul>
					<li>
						<a rel="noopener" target="_blank" href="https://www.symbolon.com" title="Ausbildungszentrum für Reflexionskompetenz in der Wirtschaft">
							Symbolon AG
						</a>
					</li>
					<li>
					...
					<li>
						<a rel="noopener" target="_blank" href="https://www.sabinestock.com/" title="Stärken. Revolution. Die Stärke deiner Einzigartigkeit!">
							StärkenRevolution | Sabine Stock
						</a>
					</li>
					<li>
