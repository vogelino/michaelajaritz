export default {
	...
	site: {
		...
		description: 'Training, Coatching und Moderation für Sie persönnllich oder für Teams und Gruppen, systemisch, mit der <a href="/fokus" title="Im Fokus - Was ist die Symbolon Methode?">Symbolon-Methode®</a>.',
	},
	pages: {
		willkommen: {
			title: 'Willkommen',
		...
		kontakt: {
			...
			content: {
				...
				finalSentence: 'Schreiben Sie mir, rufen Sie mich an oder treffen Sie mich bei einer der nächsten <a href="/angebot">Symbolon Art4Reflection-Veranstaltungen</a>. Ich freue mich auf Sie.',
			},
		},
		kooperationen: {
			title: 'Kooperationen',
