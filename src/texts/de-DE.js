export default {
	testString: 'hello',
	site: {
		title: ' | Michaela Jaritz | Training, Coatching und Moderation',
		slogan: {
	...
	pages: {
		...
		angebot: {
			...
			content: {
				...
				art4reflectionText: 'Das Coaching im Museum findet als offene Veranstaltung für Gruppen mit max. 10 Teilnehmern statt oder exklusiv für Ihr Team. In der etwa 1,5-stündigen Führung erleben Sie einen Reflexionsprozess mit drei unterschiedlichen Kunstwerken.  <br />Treffen Sie mich bei den Führungen in Leipzig, im Museum der bildenden Künste.  <br /> <br /><strong>Aktuelle Symbolon Art4Reflection-Termine:</strong> <br />Mittwoch, 6. Juni um 18:00 Uhr<br />Mittwoch, 27. Juni um 18: 00 Uhr<br /> <br />Anmeldung per Email an <a href="mailto:michaela.jaritz@outlook.de" title="Kontaktiere Michaela per E-Mail">michaela.jaritz@outlook.de</a>. Symbolon Art4Reflection ist eine internationale Initiative, weitere Informationen und alle Termine unter:  <a href="https://symbolon.com/art4reflection" target="_blank" rel="nofollow noreferrer">symbolon.com/art4reflection</a>', // eslint-disable-line
			},
		},
		fokus: {
			title: 'Im Fokus',
